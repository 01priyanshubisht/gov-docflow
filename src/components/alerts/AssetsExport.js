...
// Export error and success messages for backward compatibility
export const SuccessMsg = (message) => ({ status: "success", message });
export const ErrorMsg = (message) => ({ status: "error", message });
